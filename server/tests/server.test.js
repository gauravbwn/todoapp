...
describe('DELETE /todos/:id', () => {
  ...
  it('should not delete a todo not belonging to the authenticated user', (done) => {
...
describe('PATCH /todo/:id', () => {
  ...
  it('should not be able to update a todo not belonging to corresponding user', (done) => {
    var hexID = todos[1]._id.toHexString();
    var updatedObjective = 'I have changed the objective';
    request(app)
      .patch(`/todos/${hexID}`)
...
describe('POST /users/login', () => {
  it('should login an authentic user and return auth token', (done) => {
  ...
  it('should return 400 for an invalid login attempt', (done) => {
    var email = users[1].email;
